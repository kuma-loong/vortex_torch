...
from vortex_torch.indexer import approxTopK, Mean, GeMM
from vortex_torch.cache import Mean as CMean
from vortex_torch.abs import ContextBase


@register("claude_opus_4_7_batch_0_id1_cls")
class ClaudeOpus47Batch0Id1Cls(vFlow):
    """id0 with approxTopK(0.1) terminal op."""
    def __init__(self):
        super().__init__()
        self.q_mean = Mean(dim=1)
        self.score_gemm = GeMM()
        self.output_func = approxTopK(tolerate_ratio=0.1)
