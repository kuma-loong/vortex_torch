...
from vortex_torch.indexer import GeMM, Mean, Multiply, topK
from vortex_torch.cache import Mean as CMean


@register("gpt_5_innovate_0_id13_cls")
class KeyValueAgreementProduct(vFlow):
    def __init__(self):
        super().__init__()
    ...
    def forward_indexer(self, q: torch.Tensor, o: torch.Tensor, cache: Dict[str, torch.Tensor], ctx: ContextBase):
        ...
        score = self.product(key_score, value_score, ctx=ctx)
