"""Schedule.S cross-row reduce — launcher emitter (backend-agnostic).

One Triton/CUDA program per (batch, kv_head). Each program walks the
...
from ....utils import INDENT, Schedule
